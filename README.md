...
- ***Recommended flags for using TurboQuant with Intel ARC and Xe integrated graphics: "-ctv turbo3 -ctk turbo3 --no-op-offload --delta-cache --no-host --mlock --no-slots --no-mmap -fa on"***
