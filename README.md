...
- **Vulkan and SYCL TurboQuant is now supported in this fork, including turbo2/turbo3/turbo4 paths and a clean Windows `build-turbo` flow. Make sure to specify --device SYCL0 or --device Vulkan0 or the model may try to load via both backends!**
...
- ***Recommended flags for using TurboQuant with Intel ARC and Xe integrated graphics: "-ctv turbo3 -ctk turbo3 --delta-cache --no-host --mlock -np 1 --no-mmap -fa on"***
