...
void process_shaders() {
...
#if defined(GGML_VULKAN_INTEGER_DOT_GLSLC_SUPPORT)
                    // MMQ path has no TurboQuant code path; skip.
    ...
    // turbo*_0 copy-from-quant only; copy-to-quant is omitted because the non-SET_ROWS quantize() path lacks the WHT transform
