...
#define BLOCK_BYTE_SIZE 34 // block_turbo2_0: 2 (norm) + 32 (qs) = 34 bytes
#endif

// turbo*: define BLOCK_BYTE_SIZE early (before first use in FA offset computation)
...
#if defined(DATA_A_TURBO4_0) && !defined(BLOCK_BYTE_SIZE)
